  ...
  return (
   ...
   <div className='bg-slate-900 p-10 rounded-lg shadow-lg w-full sm:w-96 text-indigo-300 text-sm'>
    ...
    <h2 className='text-3xl font-semibold text-white text-center mb-3'>
        {state === 'Sign Up' ? 'Create Acoount' : 'Login'}</h2>
...
{state === 'Sign Up' && (<div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5
    rounded-full bg-[#333A5C]'>
        ...
        value={name}
         className='bg-transparent outline-null' type='text' 
  ...
  <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5
    rounded-full bg-[#333A5C]'>
        ...
        value={email}
        className='bg-transparent outline-null' type='Email' 
    ...
    rounded-full bg-[#333A5C]'>
        ...
        value={password}
         className='bg-transparent outline-null' type='password' 
